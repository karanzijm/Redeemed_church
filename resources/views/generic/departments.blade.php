                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="links">
                                <a href="{{ route('departments.create') }}" class="btn btn-primary button">Add Department</a>
                            </div>
                                <table class="table table-bordered">
                                    ...
                                    <tr id="tr_{{$department->id}}">
                                        <td></td>
                                        <td>{{$department->name}}</td>

                                        <td>
                                            <a href="{{ route('edit',$department->id) }}" class="edit btn btn-success btn-sm">Edit</a>
                                     </td>
                                    </tr>
                            ...
                            <p>
                                Displaying {{$departments->count()}} of {{ $departments->total() }} department(s).
                            </p>
                        </div>
